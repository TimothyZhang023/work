(self.webpackChunkgemini_chat_unified =
  ...
  [956],
  {
      ...
      var e = t(15671),
        ...
        L = (function (k) {
          ...
          function N() {
            ...
            (0, e.Z)(this, N);
            for (
              var te = arguments.length, Ee = new Array(te), ie = 0;
              ie < te;
              ie++
            )
              Ee[ie] = arguments[ie];
            return (
              (z = I.call.apply(I, [this].concat(Ee))),
              (0, U.Z)((0, v.Z)(z), "state", { hasError: !1, errorInfo: "" }),
              z
            );
          }
          return (
              ...
              [
                {
                  ...
                  value: function (te) {
                    return { hasError: !0, errorInfo: te.message };
                  },
                },
              ]
            ),
    ...
    69760: function (Y, Q, t) {
      ...
      function T(k) {
        if (!k) return;
        const { closable: I, closeIcon: N } = k;
        return { closable: I, closeIcon: N };
      }
      function R(k) {
        const { closable: I, closeIcon: N } = k || {};
        return e.useMemo(() => {
          if (!I && (I === !1 || N === !1 || N === null)) return !1;
          if (I === void 0 && N === void 0) return null;
          let z = {
          ...
          return (
            I &&
              typeof I == "object" &&
              (z = Object.assign(Object.assign({}, z), I)),
            z
          );
        }, [I, N]);
      }
      const W = {},
        L = (k, I, N = W) => {
          const z = R(k),
            te = R(I),
            [Ee] = (0, D.Z)("global", H.Z.global),
            ie = typeof z != "boolean" ? !!(z != null && z.disabled) : !1,
            be = e.useMemo(
              () => Object.assign({ closeIcon: e.createElement(B.Z, null) }, N),
              [N]
            ),
            Pe = e.useMemo(
              () =>
          ...
          return e.useMemo(() => {
            var Le, he;
            if (Pe === !1) return [!1, null, ie, {}];
            const { closeIconRender: Ae } = be,
              { closeIcon: $ } = Pe;
            let _ = $;
            const Z = (0, v.Z)(Pe, !0);
            return (
              _ != null &&
                (Ae && (_ = Ae($)),
                (_ = e.isValidElement(_)
                  ? e.cloneElement(
                      _,
                      Object.assign(
                        Object.assign(Object.assign({}, _.props), {
                          "aria-label":
                            (he =
                              (Le = _.props) === null || Le === void 0
                                ? void 0
                                : Le["aria-label"]) !== null && he !== void 0
                              ? he
                              : Ee.close,
                        }),
                        Z
                  ...
                  : e.createElement(
                      "span",
                      Object.assign({ "aria-label": Ee.close }, Z),
                      _
                    ))),
              [!0, _, ie, Z]
            );
    ...
    85265: function (Y, Q, t) {
      ...
      var e = t(67294),
        ...
        Ee = t(91),
        ie = t(42550),
        be = ["prefixCls", "className", "containerRef"],
        Pe = function (s) {
          var p = s.prefixCls,
            c = s.className,
            h = s.containerRef,
          ...
          return e.createElement(
            ...
            (0, I.Z)(
              {
                className: v()("".concat(p, "-content"), c),
                role: "dialog",
                ref: O,
              },
              (0, te.Z)(s, { aria: !0 }),
        ...
        he = t(80334);
      function Ae(r) {
        return typeof r == "string" && String(Number(r)) === r
          ? ((0, he.ZP)(
              !1,
      ...
      function Z(r, s) {
        ...
        var at = function (Ge) {
          ...
          switch (st) {
            case z.Z.TAB: {
              if (st === z.Z.TAB) {
                if (!ct && document.activeElement === qe.current) {
                  var dt;
                  (dt = tt.current) === null ||
                    dt === void 0 ||
                    dt.focus({ preventScroll: !0 });
                } else if (ct && document.activeElement === tt.current) {
                  var ut;
                  (ut = qe.current) === null ||
                    ut === void 0 ||
                    ut.focus({ preventScroll: !0 });
                }
              }
              break;
            }
            case z.Z.ESC: {
              Ze && x && (Ge.stopPropagation(), Ze(Ge));
              break;
            }
          }
        };
        ...
        var Je =
            (p =
              (c = (h = lt) === null || h === void 0 ? void 0 : h.distance) !==
                null && c !== void 0
                ? c
                : ke == null
                ? void 0
                : ke.pushDistance) !== null && p !== void 0
              ? p
              : 180,
          mt = e.useMemo(
            function () {
        ...
        var pt = e.createElement(
            N.ZP,
            (0, I.Z)({ key: "mask" }, fe, { visible: G && w }),
            function (De, Ge) {
              var st = De.className,
                ct = De.style;
              return e.createElement("div", {
                className: v()(
                  "".concat(C, "-mask"),
                  st,
                  A == null ? void 0 : A.mask,
                  Xe
                ),
                style: (0, D.Z)(
                  (0, D.Z)((0, D.Z)({}, ct), Ue),
                  we == null ? void 0 : we.mask
                ),
                onClick: q && w ? Ze : void 0,
                ref: Ge,
              });
            }
          ),
          ft = typeof J == "function" ? J(y) : J,
          it = {};
        if (ot && Je)
          switch (y) {
            case "top":
              it.transform = "translateY(".concat(Je, "px)");
              break;
            case "bottom":
              it.transform = "translateY(".concat(-Je, "px)");
              break;
            case "left":
              it.transform = "translateX(".concat(Je, "px)");
              break;
            default:
              it.transform = "translateX(".concat(-Je, "px)");
              break;
                  ...
                  (0, I.Z)(
                    {
                      ...
                      containerRef: Ge,
                      prefixCls: C,
                      className: v()(ae, A == null ? void 0 : A.content),
                      style: (0, D.Z)(
                        (0, D.Z)({}, de),
                        we == null ? void 0 : we.content
                      ),
                    },
                    (0, te.Z)(r, { aria: !0 }),
                    ht
      ...
      var le = e.forwardRef(Z),
        ge = le,
        We = function (s) {
          var p = s.open,
            c = p === void 0 ? !1 : p,
            h = s.prefixCls,
            C = h === void 0 ? "rc-drawer" : h,
            w = s.placement,
            y = w === void 0 ? "right" : w,
            O = s.autoFocus,
            P = O === void 0 ? !0 : O,
          ...
          (0, T.Z)(
            function () {
              we && (Qe.current = document.activeElement);
            },
            [we]
          );
          var tt = function (ot) {
        ...
        ue = (r) => {
          ...
          O === !1
            ...
            ? (ne = "start")
            : (ne =
                (O == null ? void 0 : O.placement) === "end" ? "end" : "start");
              ...
              return !C && !J
                ...
                : e.createElement(
                    "div",
                    {
                      ...
                      className: v()(
                        `${c}-header`,
                        { [`${c}-header-close-only`]: J && !C && !y },
                        (q = ae.classNames) === null || q === void 0
                          ? void 0
                          : q.header,
                        X == null ? void 0 : X.header
                      ),
                    },
                    e.createElement(
                      "div",
                      ...
                      C &&
                        e.createElement(
                          "div",
                          { className: `${c}-title`, id: h },
                          C
                        )
                    ),
                    y && e.createElement("div", { className: `${c}-extra` }, y),
                    ne === "end" && Oe
                  );
            },
            ve = () => {
              ...
              return e.createElement(
                "div",
                {
                  className: v()(
                    fe,
                    (G = ae.classNames) === null || G === void 0
                      ? void 0
                      : G.footer,
                    X == null ? void 0 : X.footer
                  ),
                  style: Object.assign(
                    Object.assign(
                      Object.assign(
                        {},
                        (q = ae.styles) === null || q === void 0
                          ? void 0
                          : q.footer
                      ),
                      A
                    ),
                    K == null ? void 0 : K.footer
                  ),
                },
                w
              );
            ...
            e.createElement(
              "div",
              {
                className: v()(
                  ...
                  (s = ae.classNames) === null || s === void 0 ? void 0 : s.body
                ),
                style: Object.assign(
                  Object.assign(
                    Object.assign(
                      {},
                      (p = ae.styles) === null || p === void 0 ? void 0 : p.body
                    ),
                    x
                  ),
              ...
              P
                ? e.createElement(oe.Z, {
                    active: !0,
                    title: !1,
                    paragraph: { rows: 5 },
                    className: `${c}-body-skeleton`,
                  })
                : ee
            ),
            ve()
      ...
      const Fe = (r) => {
        ...
        Te = (r, s) => ({
          "&-enter, &-appear": Object.assign(Object.assign({}, r), {
            "&-active": s,
          }),
          "&-leave": Object.assign(Object.assign({}, s), { "&-active": r }),
        }),
        xe = (r, s) =>
          Object.assign(
            {
              "&-enter, &-appear, &-leave": {
                ...
                "&-active": { transition: `all ${s}` },
              },
            },
            Te({ opacity: r }, { opacity: 1 })
          ),
        d = (r, s) => [
          xe(0.7, s),
          Te({ transform: Fe(r) }, { transform: "none" }),
        ];
      var l = (r) => {
        const { componentCls: s, motionDurationSlow: p } = r;
        return {
          [s]: {
            [`${s}-mask-motion`]: xe(0, p),
            [`${s}-panel-motion`]: ["left", "right", "top", "bottom"].reduce(
              (c, h) =>
                Object.assign(Object.assign({}, c), { [`&-${h}`]: d(h, p) }),
              {}
            ),
          },
        };
      ...
      const g = (r) => {
          const {
              ...
              colorText: Oe,
              fontWeightStrong: je,
              footerPaddingBlock: ve,
              footerPaddingInline: G,
              calc: q,
            } = r,
            fe = `${p}-content-wrapper`;
          return {
            [p]: {
              position: "fixed",
              inset: 0,
              ...
              "&-pure": {
                ...
                [`&${p}-left`]: { boxShadow: r.boxShadowDrawerLeft },
                [`&${p}-right`]: { boxShadow: r.boxShadowDrawerRight },
                [`&${p}-top`]: { boxShadow: r.boxShadowDrawerUp },
                [`&${p}-bottom`]: { boxShadow: r.boxShadowDrawerDown },
              },
              ...
              [`&-left > ${fe}`]: {
                ...
                boxShadow: r.boxShadowDrawerLeft,
              },
              [`&-right > ${fe}`]: {
                top: 0,
                right: { _skip_check_: !0, value: 0 },
                bottom: 0,
                boxShadow: r.boxShadowDrawerRight,
              },
              [`&-top > ${fe}`]: {
                top: 0,
                insetInline: 0,
                boxShadow: r.boxShadowDrawerUp,
              },
              [`&-bottom > ${fe}`]: {
                bottom: 0,
                insetInline: 0,
                boxShadow: r.boxShadowDrawerDown,
              },
              [`${p}-content`]: {
                display: "flex",
                flexDirection: "column",
              ...
              [`${p}-header`]: {
                ...
                flex: 0,
                alignItems: "center",
                padding: `${(0, ce.bf)(P)} ${(0, ce.bf)(F)}`,
                fontSize: j,
                lineHeight: x,
                borderBottom: `${(0, ce.bf)(A)} ${ee} ${X}`,
                "&-title": {
                  display: "flex",
                  flex: 1,
                  alignItems: "center",
              ...
              [`${p}-close`]: Object.assign(
                {
                  display: "inline-flex",
                  width: q(j).add(O).equal(),
                  height: q(j).add(O).equal(),
                  borderRadius: s,
                  ...
                  transition: `all ${y}`,
                  textRendering: "auto",
                  [`&${p}-close-end`]: { marginInlineStart: K },
                  [`&:not(${p}-close-end)`]: { marginInlineEnd: K },
                  "&:hover": {
                    color: ne,
                    backgroundColor: de,
                    textDecoration: "none",
              ...
              [`${p}-footer`]: {
                flexShrink: 0,
                padding: `${(0, ce.bf)(ve)} ${(0, ce.bf)(G)}`,
                borderTop: `${(0, ce.bf)(A)} ${ee} ${X}`,
              },
              "&-rtl": { direction: "rtl" },
            },
          };
        ...
        f = (r) => ({
          zIndexPopup: r.zIndexPopupBase,
          footerPaddingBlock: r.paddingXS,
          footerPaddingInline: r.padding,
        });
      var b = (0, $e.I$)(
          "Drawer",
          (r) => {
        ...
        E = function (r, s) {
          ...
          if (r != null && typeof Object.getOwnPropertySymbols == "function")
            for (
              var h = 0, c = Object.getOwnPropertySymbols(r);
              h < c.length;
              h++
            )
              s.indexOf(c[h]) < 0 &&
                Object.prototype.propertyIsEnumerable.call(r, c[h]) &&
                (p[c[h]] = r[c[h]]);
          return p;
        };
      const a = null,
        ...
        o = (r) => {
          ...
          const {
              ...
              "aria-labelledby": K,
              visible: ae,
              afterVisibleChange: ne,
              maskStyle: de,
              drawerStyle: J,
              contentWrapperStyle: Oe,
              destroyOnClose: je,
              destroyOnHidden: ve,
            } = r,
            G = E(r, [
            ...
            Se = Ue("drawer", j),
            [Ke, _e, we] = b(Se),
            et = x === void 0 && Xe ? () => Xe(document.body) : x,
            Qe = v()({ "no-mask": !w, [`${Se}-rtl`]: Be === "rtl" }, p, _e, we),
            tt = e.useMemo(
              () => (c != null ? c : C === "large" ? 736 : 378),
              [c, C]
            ),
            qe = e.useMemo(
              () => (h != null ? h : C === "large" ? 736 : 378),
              [h, C]
            ),
            at = {
              motionName: (0, Ne.m)(Se, "mask-motion"),
              motionAppear: !0,
              motionEnter: !0,
              motionLeave: !0,
              motionDeadline: 500,
            ...
            nt = (mt) => ({
              motionName: (0, Ne.m)(Se, `panel-motion-${mt}`),
              motionAppear: !0,
              motionEnter: !0,
              motionLeave: !0,
              motionDeadline: 500,
            ...
            Ie = (0, S.H)(),
            ot = (0, ie.sQ)(A, Ie),
            [rt, ke] = (0, pe.Cn)("Drawer", G.zIndex),
            { classNames: lt = {}, styles: Je = {} } = G;
          return Ke(
            e.createElement(
              me.Z,
              { form: !0, space: !0 },
              e.createElement(
                ...
                e.createElement(
                  re,
                  Object.assign(
                    { prefixCls: Se, onClose: F, maskMotion: at, motion: nt },
                    G,
                    {
                      classNames: {
                        mask: v()(lt.mask, Ve.mask),
                        content: v()(lt.content, Ve.content),
                        wrapper: v()(lt.wrapper, Ve.wrapper),
                      },
                      styles: {
                        mask: Object.assign(
                          Object.assign(Object.assign({}, Je.mask), de),
                          Re.mask
                        ),
                        content: Object.assign(
                          Object.assign(Object.assign({}, Je.content), J),
                          Re.content
                        ),
                        wrapper: Object.assign(
                          Object.assign(Object.assign({}, Je.wrapper), Oe),
                          Re.wrapper
                        ),
                      },
                      open: O != null ? O : ae,
                      ...
                      width: tt,
                      height: qe,
                      style: Object.assign(Object.assign({}, Ye), ee),
                      className: v()(Ze, X),
                      rootClassName: Qe,
                      getContainer: et,
                      afterOpenChange: P != null ? P : ne,
                      panelRef: ot,
                      zIndex: rt,
                      "aria-labelledby": K != null ? K : fe,
                      destroyOnClose: ve != null ? ve : je,
                    }
                  ),
                  e.createElement(
                    ue,
                    Object.assign({ prefixCls: Se }, G, {
                      ariaId: fe,
                      onClose: F,
                    })
                  )
        ...
        u = (r) => {
          const {
            ...
            C = E(r, ["prefixCls", "style", "className", "placement"]),
            { getPrefixCls: w } = e.useContext(He.E_),
            y = w("drawer", s),
            [O, P, F] = b(y),
            j = v()(y, `${y}-pure`, `${y}-${h}`, P, F, c);
          return O(
            e.createElement(
              "div",
              { className: j, style: p },
              e.createElement(ue, Object.assign({ prefixCls: y }, C))
            )
          );
        };
      o._InternalPanelDoNotUseOrYouWillBeFired = u;
      var i = o;
    },
    89609: function (Y, Q, t) {
      "use strict";
      t.d(Q, {
        Z: function () {
          return m;
      ...
      var e = t(67294),
        ...
        L = t(87263),
        I = (l) =>
          (typeof l != "object" && typeof l != "function") || l === null,
        N = t(80636),
        z = t(8745),
        te = t(96159),
        Ee = t(27288),
            ...
            [`${g}, ${g}-menu-submenu`]: {
              [`${f} ${a}`]: {
                [`&${a}-danger:not(${a}-disabled)`]: {
                  color: b,
                  "&:hover": { color: E, backgroundColor: b },
                },
              },
            },
          };
          ...
          return [
            {
              [g]: {
                ...
                "&::before": {
                  position: "absolute",
                  insetBlock: l.calc(a).div(2).sub(E).equal(),
                  zIndex: -9999,
                  opacity: 1e-4,
                  content: '""',
                },
                ...
                [`&-trigger${n}-btn`]: {
                  [`& > ${o}-down, & > ${n}-btn-icon > ${o}-down`]: {
                    fontSize: c,
                  },
                },
                [`${g}-wrap`]: {
                  position: "relative",
                  [`${n}-btn > ${o}-down`]: { fontSize: c },
                  [`${o}-down::before`]: { transition: `transform ${u}` },
                },
                [`${g}-wrap-open`]: {
                  [`${o}-down::before`]: { transform: "rotate(180deg)" },
                },
                "\n        &-hidden,\n        &-menu-hidden,\n        &-menu-submenu-hidden\n      ":
                  { display: "none" },
                [`&${n}-slide-down-enter${n}-slide-down-enter-active${g}-placement-bottomLeft,
          &${n}-slide-down-appear${n}-slide-down-appear-active${g}-placement-bottomLeft,
          &${n}-slide-down-enter${n}-slide-down-enter-active${g}-placement-bottom,
          &${n}-slide-down-appear${n}-slide-down-appear-active${g}-placement-bottom,
          &${n}-slide-down-enter${n}-slide-down-enter-active${g}-placement-bottomRight,
          &${n}-slide-down-appear${n}-slide-down-appear-active${g}-placement-bottomRight`]:
                  { animationName: Z.fJ },
                [`&${n}-slide-up-enter${n}-slide-up-enter-active${g}-placement-topLeft,
          &${n}-slide-up-appear${n}-slide-up-appear-active${g}-placement-topLeft,
          &${n}-slide-up-enter${n}-slide-up-enter-active${g}-placement-top,
          &${n}-slide-up-appear${n}-slide-up-appear-active${g}-placement-top,
          &${n}-slide-up-enter${n}-slide-up-enter-active${g}-placement-topRight,
          &${n}-slide-up-appear${n}-slide-up-appear-active${g}-placement-topRight`]:
                  { animationName: Z.Qt },
                [`&${n}-slide-down-leave${n}-slide-down-leave-active${g}-placement-bottomLeft,
          &${n}-slide-down-leave${n}-slide-down-leave-active${g}-placement-bottom,
          &${n}-slide-down-leave${n}-slide-down-leave-active${g}-placement-bottomRight`]:
                  { animationName: Z.Uw },
                [`&${n}-slide-up-leave${n}-slide-up-leave-active${g}-placement-topLeft,
          &${n}-slide-up-leave${n}-slide-up-leave-active${g}-placement-top,
          &${n}-slide-up-leave${n}-slide-up-leave-active${g}-placement-topRight`]:
                  { animationName: Z.ly },
              },
            },
            (0, We.ZP)(l, C, { arrowPlacement: { top: !0, bottom: !0 } }),
            {
              [`${g} ${f}`]: { position: "relative", margin: 0 },
              [`${f}-submenu-popup`]: {
                position: "absolute",
                zIndex: b,
                background: "transparent",
              ...
              [`${g}, ${g}-menu-submenu`]: Object.assign(
                Object.assign({}, (0, _.Wf)(l)),
                {
                  [f]: Object.assign(
                    Object.assign(
                      {
                    ...
                    ),
                    {
                      ...
                      [`${f}-title-content`]: {
                        ...
                        [`${f}-item-extra`]: {
                          paddingInlineStart: l.padding,
                          marginInlineStart: "auto",
                          fontSize: l.fontSizeSM,
                          color: l.colorTextDescription,
                        },
                      },
                      [`${f}-item, ${f}-submenu-title`]: Object.assign(
                        Object.assign(
                          {
                            display: "flex",
                            margin: 0,
                        ...
                        ),
                        {
                          "&-selected": {
                            ...
                            "&:hover, &-active": {
                              backgroundColor: l.controlItemBgActiveHover,
                            },
                          },
                          "&-disabled": {
                            color: p,
                          ...
                          "&-divider": {
                            height: 1,
                            margin: `${(0, $.bf)(l.marginXXS)} 0`,
                            overflow: "hidden",
                            lineHeight: 0,
                            backgroundColor: l.colorSplit,
                          },
                          [`${g}-menu-submenu-expand-icon`]: {
                            position: "absolute",
                            insetInlineEnd: l.paddingXS,
                            [`${g}-menu-submenu-arrow-icon`]: {
                      ...
                      [`${f}-item-group-list`]: {
                        margin: `0 ${(0, $.bf)(l.marginXS)}`,
                        padding: 0,
                        listStyle: "none",
                      },
                      [`${f}-submenu-title`]: {
                        paddingInlineEnd: l.calc(h).add(l.fontSizeSM).equal(),
                      },
                      [`${f}-submenu-vertical`]: { position: "relative" },
                      [`${f}-submenu${f}-submenu-disabled ${g}-menu-submenu-title`]:
                        {
                          [`&, ${g}-menu-submenu-arrow-icon`]: {
                            color: p,
                            backgroundColor: C,
                      ...
                      [`${f}-submenu-selected ${g}-menu-submenu-title`]: {
                        color: l.colorPrimary,
                      },
                    }
                  ),
            ...
            Object.assign(
              {
                ...
                paddingBlock: (l.controlHeight - l.fontSize * l.lineHeight) / 2,
              },
              (0, We.wZ)({
                contentRadius: l.borderRadiusLG,
      ...
      var He = (0, re.I$)(
        ...
        (l) => {
          const {
            ...
            a = (0, se.IX)(l, {
              menuCls: `${E}-menu`,
              dropdownArrowDistance: l.calc(f).div(2).add(g).equal(),
      ...
      const S = null,
        M = (l) => {
          ...
          const {
            ...
            [fe, Xe, Ue] = He(G, q),
            [, Be] = (0, Ae.ZP)(),
            Ze = e.Children.only(I(a) ? e.createElement("span", null, a) : a),
            Ye = (0, te.Tm)(Ze, {
              className: H()(
                `${G}-trigger`,
                { [`${G}-rtl`]: ne === "rtl" },
              ...
              disabled:
                (g = Ze.props.disabled) !== null && g !== void 0 ? g : o,
            }),
            Ve = o ? [] : n,
            Re = !!(Ve != null && Ve.includes("contextMenu")),
            [Se, Ke] = (0, R.Z)(!1, { value: h != null ? h : w }),
            _e = (0, T.Z)((Ie) => {
              C == null || C(Ie, { source: "trigger" }),
                y == null || y(Ie),
                Ke(Ie);
            }),
            we = H()(s, p, Xe, Ue, q, de == null ? void 0 : de.className, {
              [`${G}-rtl`]: ne === "rtl",
            }),
            et = (0, N.Z)({
              ...
              offset: Be.marginXXS,
              arrowWidth: b ? Be.sizePopupArrow : 0,
              borderRadius: Be.borderRadius,
            }),
            Qe = (0, T.Z)(() => {
              (f != null && f.selectable && f != null && f.multiple) ||
                (C == null || C(!1, { source: "menu" }), Ke(!1));
            }),
            tt = () => {
              let Ie;
              return (
                f != null && f.items
                  ? (Ie = e.createElement(Le.Z, Object.assign({}, f)))
                  : typeof x == "function"
                  ? (Ie = x())
                  : (Ie = x),
                J && (Ie = J(Ie)),
                (Ie = e.Children.only(
                  typeof Ie == "string" ? e.createElement("span", null, Ie) : Ie
                )),
                e.createElement(
                  he.J,
                  {
                    prefixCls: `${G}-menu`,
                    rootClassName: H()(Ue, q),
                    expandIcon: e.createElement(
                      "span",
                      { className: `${G}-menu-submenu-arrow` },
                      ne === "rtl"
                        ? e.createElement(B.Z, {
                            className: `${G}-menu-submenu-arrow-icon`,
                          })
                        : e.createElement(v.Z, {
                            className: `${G}-menu-submenu-arrow-icon`,
                          })
            ...
            [qe, at] = (0, L.Cn)("Dropdown", c == null ? void 0 : c.zIndex);
          let nt = e.createElement(
            U.Z,
            Object.assign({ alignPoint: Re }, (0, W.Z)(l, ["rootClassName"]), {
              mouseEnterDelay: O,
              mouseLeaveDelay: P,
              visible: Se,
              ...
              overlayStyle: Object.assign(
                Object.assign(
                  Object.assign({}, de == null ? void 0 : de.style),
                  c
                ),
                { zIndex: qe }
              ),
              autoDestroy: ee != null ? ee : X,
            }),
            Ye
          );
          return (
            qe && (nt = e.createElement(ie.Z.Provider, { value: at }, nt)),
            fe(nt)
          );
        },
        oe = (0, z.Z)(M, "align", void 0, "dropdown", (l) => l),
        Ce = (l) =>
          e.createElement(
            oe,
            Object.assign({}, l),
      ...
      M._InternalPanelDoNotUseOrYouWillBeFired = Ce;
      var ue = M,
        ce = t(89705),
        ye = t(83622),
        $e = t(98081),
        ...
        Fe = function (l, g) {
          ...
          if (l != null && typeof Object.getOwnPropertySymbols == "function")
            for (
              var E = 0, b = Object.getOwnPropertySymbols(l);
              E < b.length;
              E++
            )
              g.indexOf(b[E]) < 0 &&
                Object.prototype.propertyIsEnumerable.call(l, b[E]) &&
                (f[b[E]] = l[b[E]]);
          return f;
        };
      const Te = (l) => {
        const {
          ...
          } = e.useContext(be.E_),
          {
            ...
            getPopupContainer: x,
            href: A,
            icon: ee = e.createElement(ce.Z, null),
            title: X,
            buttonsRender: K = (we) => we,
            mouseEnterDelay: ae,
            mouseLeaveDelay: ne,
            overlayClassName: de,
            overlayStyle: J,
            destroyOnHidden: Oe,
            destroyPopupOnHide: je,
            dropdownRender: ve,
            popupRender: G,
          } = l,
          q = Fe(l, [
          ...
          { compactSize: Ze, compactItemClassnames: Ye } = (0, ze.ri)(fe, b),
          Ve = H()(Xe, Ye, p);
        "destroyPopupOnHide" in l && (Be.destroyPopupOnHide = je),
          "overlay" in l && (Be.overlay = w),
          "open" in l && (Be.open = P),
          "placement" in l
            ? (Be.placement = j)
            : (Be.placement = b === "rtl" ? "bottomLeft" : "bottomRight");
        const Re = e.createElement(
          ...
          Se = e.createElement(ye.ZP, { type: a, danger: n, icon: ee }),
          [Ke, _e] = K([Re, Se]);
        return e.createElement(
          $e.Z.Compact,
          Object.assign({ className: Ve, size: Ze, block: !0 }, q),
          Ke,
          e.createElement(ue, Object.assign({}, Be), _e)
        );
      };
      Te.__ANT_BUTTON = !0;
      var xe = Te;
    ...
    23342: function (Y, Q, t) {
      ...
      var e = t(67294),
        ...
        H = t(84089),
        U = function (re, se) {
          return e.createElement(H.Z, (0, B.Z)({}, re, { ref: se, icon: D }));
        },
        T = e.forwardRef(U),
        R = T,
        W = t(6171),
      ...
      const Le = (V) => {
        const {
          componentCls: re,
          siderBg: se,
          motionDurationMid: me,
          motionDurationSlow: pe,
          antCls: Ne,
          triggerHeight: Me,
          triggerColor: He,
          triggerBg: S,
          headerHeight: M,
          zeroTriggerWidth: oe,
          zeroTriggerHeight: Ce,
          borderRadiusLG: ue,
          lightSiderBg: ce,
          lightTriggerColor: ye,
          lightTriggerBg: $e,
          bodyBg: ze,
        } = V;
        return {
          [re]: {
            ...
            minWidth: 0,
            background: se,
            transition: `all ${me}, background 0s`,
            "&-has-trigger": { paddingBottom: Me },
            "&-right": { order: 1 },
            [`${re}-children`]: {
              height: "100%",
              marginTop: -0.1,
              paddingTop: 0.1,
              [`${Ne}-menu${Ne}-menu-inline-collapsed`]: { width: "auto" },
            },
            [`&-zero-width ${re}-children`]: { overflow: "hidden" },
            [`${re}-trigger`]: {
              position: "fixed",
              bottom: 0,
              zIndex: 1,
              height: Me,
              color: He,
              lineHeight: (0, ie.bf)(Me),
              textAlign: "center",
              background: S,
              cursor: "pointer",
              transition: `all ${me}`,
            },
            [`${re}-zero-width-trigger`]: {
              position: "absolute",
              top: M,
              insetInlineEnd: V.calc(oe).mul(-1).equal(),
              zIndex: 1,
              width: oe,
              height: Ce,
              color: He,
              fontSize: V.fontSizeXL,
              display: "flex",
              alignItems: "center",
              justifyContent: "center",
              background: se,
              borderRadius: `0 ${(0, ie.bf)(ue)} ${(0, ie.bf)(ue)} 0`,
              cursor: "pointer",
              transition: `background ${pe} ease`,
              "&::after": {
                position: "absolute",
                inset: 0,
                background: "transparent",
              ...
              "&-right": {
                insetInlineStart: V.calc(oe).mul(-1).equal(),
                borderRadius: `${(0, ie.bf)(ue)} 0 0 ${(0, ie.bf)(ue)}`,
              },
            },
            "&-light": {
              background: ce,
              [`${re}-trigger`]: { color: ye, background: $e },
              [`${re}-zero-width-trigger`]: {
                color: ye,
                background: $e,
                border: `1px solid ${ze}`,
      ...
      var he = (0, Pe.I$)(["Layout", "Sider"], Le, be.eh, {
          deprecatedTokens: be.jn,
        }),
        Ae = function (V, re) {
          var se = {};
          for (var me in V)
            Object.prototype.hasOwnProperty.call(V, me) &&
              re.indexOf(me) < 0 &&
              (se[me] = V[me]);
          if (V != null && typeof Object.getOwnPropertySymbols == "function")
            for (
              var pe = 0, me = Object.getOwnPropertySymbols(V);
              pe < me.length;
              pe++
            )
              re.indexOf(me[pe]) < 0 &&
                Object.prototype.propertyIsEnumerable.call(V, me[pe]) &&
                (se[me[pe]] = V[me[pe]]);
          return se;
        };
      const $ = {
        ...
        _ = (V) =>
          !Number.isNaN(Number.parseFloat(V)) && Number.isFinite(Number(V)),
        Z = e.createContext({}),
        le = (() => {
          let V = 0;
          return (re = "") => ((V += 1), `${re}${V}`);
        })();
      var We = e.forwardRef((V, re) => {
        const {
            prefixCls: se,
            className: me,
            trigger: pe,
            children: Ne,
            defaultCollapsed: Me = !1,
            theme: He = "dark",
            style: S = {},
            collapsible: M = !1,
            reverseArrow: oe = !1,
            width: Ce = 200,
            collapsedWidth: ue = 80,
            zeroWidthTriggerStyle: ce,
            breakpoint: ye,
            onCollapse: $e,
            onBreakpoint: ze,
          } = V,
          ...
          { siderHook: Te } = (0, e.useContext)(Ee.V),
          [xe, d] = (0, e.useState)("collapsed" in V ? V.collapsed : Me),
          [m, l] = (0, e.useState)(!1);
        (0, e.useEffect)(() => {
          "collapsed" in V && d(V.collapsed);
        }, [V.collapsed]);
        const g = (x, A) => {
            "collapsed" in V || d(x), $e == null || $e(x, A);
          },
          { getPrefixCls: f, direction: b } = (0, e.useContext)(te.E_),
          E = f("layout-sider", se),
          [a, n, o] = he(E),
          u = (0, e.useRef)(null);
        (u.current = (x) => {
          l(x.matches),
            ze == null || ze(x.matches),
            xe !== x.matches && g(x.matches, "responsive");
        }),
          (0, e.useEffect)(() => {
            function x(ee) {
              var X;
              return (X = u.current) === null || X === void 0
                ? void 0
                : X.call(u, ee);
            }
            let A;
            return (
              typeof (window == null ? void 0 : window.matchMedia) !=
                "undefined" &&
                ye &&
                ye in $ &&
                ((A = window.matchMedia(`screen and (max-width: ${$[ye]})`)),
                (0, z.x)(A, x),
                x(A)),
              () => {
                (0, z.h)(A, x);
          ...
          (0, e.useEffect)(() => {
            const x = le("ant-sider-");
            return Te.addSider(x), () => Te.removeSider(x);
          }, []);
        const i = () => {
            g(!xe, "clickTrigger");
          },
          r = (0, N.Z)(Fe, ["collapsed"]),
          s = xe ? ue : Ce,
          p = _(s) ? `${s}px` : String(s),
          c =
            Number.parseFloat(String(ue || 0)) === 0
              ? e.createElement(
                  "span",
                  {
                    onClick: i,
                    className: I()(
                      ...
                      `${E}-zero-width-trigger-${oe ? "right" : "left"}`
                    ),
                    style: ce,
                  },
                  pe || e.createElement(R, null)
                )
              : null,
          h = (b === "rtl") == !oe,
          y = {
          ...
          F = I()(
            ...
            {
              [`${E}-collapsed`]: !!xe,
              [`${E}-has-trigger`]: M && pe !== null && !c,
              [`${E}-below`]: !!m,
              [`${E}-zero-width`]: Number.parseFloat(p) === 0,
            },
            me,
            n,
            o
          ),
          j = e.useMemo(() => ({ siderCollapsed: xe }), [xe]);
        return a(
          e.createElement(
            Z.Provider,
            { value: j },
            e.createElement(
              "aside",
              Object.assign({ className: F }, r, { style: P, ref: re }),
              e.createElement("div", { className: `${E}-children` }, Ne),
              M || (m && c) ? O : null
            )
          )
        );
    ...
    26058: function (Y, Q, t) {
      ...
      function L($, _, Z) {
        return typeof Z == "boolean"
          ...
          : $.length
          ? !0
          : (0, R.Z)(_).some((ge) => ge.type === W.Z);
      }
      var k = t(24793),
        I = function ($, _) {
          var Z = {};
          for (var le in $)
            Object.prototype.hasOwnProperty.call($, le) &&
              _.indexOf(le) < 0 &&
              (Z[le] = $[le]);
          if ($ != null && typeof Object.getOwnPropertySymbols == "function")
            for (
              var ge = 0, le = Object.getOwnPropertySymbols($);
              ge < le.length;
              ge++
            )
              _.indexOf(le[ge]) < 0 &&
                Object.prototype.propertyIsEnumerable.call($, le[ge]) &&
                (Z[le[ge]] = $[le[ge]]);
          return Z;
        };
      function N({ suffixCls: $, tagName: _, displayName: Z }) {
        return (le) =>
          B.forwardRef((We, V) =>
            B.createElement(
              le,
              Object.assign({ ref: V, suffixCls: $, tagName: _ }, We)
            )
          );
      }
      const z = B.forwardRef(($, _) => {
          const { prefixCls: Z, suffixCls: le, className: ge, tagName: We } = $,
            V = I($, ["prefixCls", "suffixCls", "className", "tagName"]),
            { getPrefixCls: re } = B.useContext(U.E_),
            se = re("layout", Z),
            [me, pe, Ne] = (0, k.ZP)(se),
            Me = le ? `${se}-${le}` : se;
          return me(
            B.createElement(
              We,
              Object.assign({ className: D()(Z || Me, ge, pe, Ne), ref: _ }, V)
            )
          );
        }),
        te = B.forwardRef(($, _) => {
          const { direction: Z } = B.useContext(U.E_),
            [le, ge] = B.useState([]),
            {
              prefixCls: We,
              className: V,
            ...
            He = (0, H.Z)(Me, ["suffixCls"]),
            { getPrefixCls: S, className: M, style: oe } = (0, U.dj)("layout"),
            Ce = S("layout", We),
            ue = L(le, se, me),
            [ce, ye, $e] = (0, k.ZP)(Ce),
            ze = D()(
              Ce,
              { [`${Ce}-has-sider`]: ue, [`${Ce}-rtl`]: Z === "rtl" },
              M,
              V,
              re,
              ye,
            ...
            Fe = B.useMemo(
              () => ({
                siderHook: {
                  addSider: (Te) => {
                    ge((xe) => [].concat((0, e.Z)(xe), [Te]));
                  },
                  removeSider: (Te) => {
                    ge((xe) => xe.filter((d) => d !== Te));
                  },
                },
              }),
              []
                ...
                Object.assign(
                  {
                    ref: _,
                    className: ze,
                    style: Object.assign(Object.assign({}, oe), Ne),
                  },
                  He
                ),
                se
        ...
        Ee = N({ tagName: "div", displayName: "Layout" })(te),
        ie = N({
          suffixCls: "header",
          tagName: "header",
          displayName: "Header",
      ...
      (he.Header = ie),
        ...
        (he.Content = Pe),
        (he.Sider = W.Z),
        (he._InternalSiderContext = W.D);
      var Ae = he;
    },
    24793: function (Y, Q, t) {
      "use strict";
      t.d(Q, {
        eh: function () {
          return D;
      ...
      const v = (U) => {
          ...
          return {
            ...
            [`${R}-content`]: { flex: "auto", color: W, minHeight: 0 },
          };
        },
        D = (U) => {
          const {
          ...
          return {
            ...
            headerBg: "#001529",
            headerHeight: R * 2,
            headerPadding: `0 ${te}px`,
            headerColor: L,
            footerPadding: `${k}px ${te}px`,
            footerBg: T,
            siderBg: "#001529",
            triggerHeight: W + I * 2,
            triggerBg: "#002140",
      ...
      Q.ZP = (0, B.I$)("Layout", v, D, { deprecatedTokens: H });
    },
    76529: function (Y, Q, t) {
      "use strict";
      t.d(Q, {
        J: function () {
          return U;
      ...
      var e = t(67294),
        ...
        D = function (T, R) {
          ...
          if (T != null && typeof Object.getOwnPropertySymbols == "function")
            for (
              var k = 0, L = Object.getOwnPropertySymbols(T);
              k < L.length;
              k++
            )
              R.indexOf(L[k]) < 0 &&
                Object.prototype.propertyIsEnumerable.call(T, L[k]) &&
                (W[L[k]] = T[L[k]]);
          return W;
        };
      const H = e.createContext(null),
        U = e.forwardRef((T, R) => {
          const { children: W } = T,
            ...
            k = e.useContext(H),
            I = e.useMemo(
              () => Object.assign(Object.assign({}, k), L),
              [k, L.prefixCls, L.mode, L.selectable, L.rootClassName]
            ),
            N = (0, B.t4)(W),
            z = (0, B.x1)(R, N ? (0, B.C4)(W) : null);
          return e.createElement(
            H.Provider,
            { value: I },
            e.createElement(
              v.Z,
              { space: !0 },
              N ? e.cloneElement(W, { ref: z }) : W
            )
          );
        });
      Q.Z = H;
    },
    50136: function (Y, Q, t) {
      "use strict";
      t.d(Q, {
        Z: function () {
          return E;
      ...
      var e = t(67294),
        ...
        te = function (a, n) {
          ...
          if (a != null && typeof Object.getOwnPropertySymbols == "function")
            for (
              var i = 0, u = Object.getOwnPropertySymbols(a);
              i < u.length;
              i++
            )
              n.indexOf(u[i]) < 0 &&
                Object.prototype.propertyIsEnumerable.call(a, u[i]) &&
                (o[u[i]] = a[u[i]]);
          return o;
        },
        ie = (a) => {
          const { prefixCls: n, className: o, dashed: u } = a,
            i = te(a, ["prefixCls", "className", "dashed"]),
            { getPrefixCls: r } = e.useContext(k.E_),
            s = r("menu", n),
            p = U()({ [`${s}-item-divider-dashed`]: !!u }, o);
          return e.createElement(B.iz, Object.assign({ className: p }, i));
        },
        be = t(50344),
        Pe = t(83062),
        he = (a) => {
          ...
          const {
            ...
            O = (ee) => {
              const X = u == null ? void 0 : u[0],
                K = e.createElement(
                  "span",
                  {
                    className: U()(`${c}-title-content`, {
                      [`${c}-title-content-with-extra`]: !!p || p === 0,
                    }),
                  },
                  u
                );
              return (!i || (e.isValidElement(u) && u.type === "span")) &&
                u &&
                ee &&
                h &&
                typeof X == "string"
            ...
            { siderCollapsed: P } = e.useContext(v.D);
          let F = r;
          typeof r == "undefined" ? (F = h ? u : "") : r === !1 && (F = "");
          const j = { title: F };
          !P && !y && ((j.title = null), (j.open = !1));
          const x = (0, be.Z)(u).length;
          let A = e.createElement(
            B.ck,
            Object.assign({}, (0, R.Z)(a, ["title", "icon", "danger"]), {
              className: U()(
                {
                  [`${c}-item-danger`]: s,
                  [`${c}-item-only-child`]: (i ? x + 1 : x) === 1,
                },
                o
              ),
            ...
            w ||
              (A = e.createElement(
                ...
                Object.assign({}, j, {
                  ...
                  classNames: { root: `${c}-inline-collapsed-tooltip` },
                }),
                A
              )),
            A
        ...
        Ne = ({ componentCls: a, menuArrowOffset: n, calc: o }) => ({
          [`${a}-rtl`]: { direction: "rtl" },
          [`${a}-submenu-rtl`]: { transformOrigin: "100% 0" },
          [`${a}-rtl${a}-vertical,
    ${a}-submenu-rtl ${a}-vertical`]: {
            [`${a}-submenu-arrow`]: {
              "&::before": {
                transform: `rotate(-45deg) translateY(${(0, $.bf)(
                  o(n).mul(-1).equal()
                )})`,
              },
              "&::after": {
                transform: `rotate(45deg) translateY(${(0, $.bf)(n)})`,
              },
            },
          },
        });
      ...
      var S = (a, n) => {
        const {
          ...
          itemDisabledColor: K,
          dangerItemColor: ae,
          dangerItemHoverColor: ne,
          dangerItemSelectedColor: de,
          dangerItemActiveBg: J,
          dangerItemSelectedBg: Oe,
          popupBg: je,
          itemHoverBg: ve,
          itemActiveBg: G,
          menuSubMenuBg: q,
          horizontalItemSelectedColor: fe,
          horizontalItemSelectedBg: Xe,
          horizontalItemBorderRadius: Ue,
          horizontalItemHoverBg: Be,
        } = a;
        return {
          [`${o}-${n}, ${o}-${n} > ${o}`]: {
            color: u,
            background: p,
            [`&${o}-root:focus-visible`]: Object.assign({}, Me(a)),
            [`${o}-item`]: { "&-group-title, &-extra": { color: s } },
            [`${o}-submenu-selected > ${o}-submenu-title`]: { color: r },
            ...
            [`${o}-item:not(${o}-item-selected):not(${o}-submenu-selected)`]: {
              [`&:hover, > ${o}-submenu-title:hover`]: { color: A },
            },
            [`&:not(${o}-horizontal)`]: {
              [`${o}-item:not(${o}-item-selected)`]: {
                "&:hover": { backgroundColor: ve },
            ...
            [`${o}-item-danger`]: {
              ...
              [`&${o}-item:active`]: { background: J },
            },
            [`${o}-item a`]: { "&, &:hover": { color: "inherit" } },
            [`${o}-item-selected`]: {
              color: i,
              [`&${o}-item-danger`]: { color: de },
              "a, a:hover": { color: "inherit" },
            },
            [`& ${o}-item-selected`]: {
              backgroundColor: h,
              [`&${o}-item-danger`]: { backgroundColor: Oe },
            },
            [`&${o}-submenu > ${o}`]: { backgroundColor: q },
            [`&${o}-popup > ${o}`]: { backgroundColor: je },
            [`&${o}-submenu-popup > ${o}`]: { backgroundColor: je },
            [`&${o}-horizontal`]: Object.assign(
              Object.assign({}, n === "dark" ? { borderBottom: 0 } : {}),
              {
                [`> ${o}-item, > ${o}-submenu`]: {
                  top: y,
                  marginTop: a.calc(y).mul(-1).equal(),
                  marginBottom: 0,
                  borderRadius: Ue,
                  "&::after": {
                    position: "absolute",
                    insetInline: j,
                    bottom: 0,
                    borderBottom: `${(0, $.bf)(C)} solid transparent`,
                    transition: `border-color ${O} ${P}`,
                    content: '""',
                  },
                  "&:hover, &-active, &-open": {
                    background: Be,
                    "&::after": { borderBottomWidth: C, borderBottomColor: fe },
                  },
                  "&-selected": {
                    color: fe,
                    backgroundColor: Xe,
                    "&:hover": { backgroundColor: Xe },
                    "&::after": { borderBottomWidth: C, borderBottomColor: fe },
                  },
                },
              }
            ...
            [`&${o}-root`]: {
              [`&${o}-inline, &${o}-vertical`]: {
                borderInlineEnd: `${(0, $.bf)(y)} ${ee} ${X}`,
              },
            },
            [`&${o}-inline`]: {
              [`${o}-sub${o}-inline`]: { background: c },
              [`${o}-item`]: {
                position: "relative",
                "&::after": {
                  position: "absolute",
                  insetBlock: 0,
                  insetInlineEnd: 0,
                  borderInlineEnd: `${(0, $.bf)(w)} solid ${i}`,
                  transform: "scaleY(0.0001)",
                  opacity: 0,
                  transition: [`transform ${x} ${F}`, `opacity ${x} ${F}`].join(
                    ","
                  ),
                  content: '""',
                },
                [`&${o}-item-danger`]: {
                  "&::after": { borderInlineEndColor: de },
                },
              },
      ...
      const M = (a) => {
        const {
          ...
          C = a.calc(r).add(i).add(s).equal();
        return {
          [`${n}-item`]: { position: "relative", overflow: "hidden" },
          [`${n}-item, ${n}-submenu-title`]: {
            height: o,
            lineHeight: (0, $.bf)(o),
            paddingInline: h,
          ...
          [`${n}-item-group-list ${n}-submenu-title,
            ${n}-submenu-title`]: { paddingInlineEnd: C },
        };
      };
      var Ce = (a) => {
        const {
        ...
        return [
          {
            ...
            [`${n}-submenu-popup`]: {
              [`${n}-vertical`]: Object.assign(Object.assign({}, M(a)), {
                boxShadow: P,
              }),
            },
          },
          {
            [`${n}-submenu-popup ${n}-vertical${n}-sub`]: {
              minWidth: r,
              maxHeight: `calc(100vh - ${(0, $.bf)(
                a.calc(s).mul(2.5).equal()
              )})`,
              padding: "0",
              overflow: "hidden",
              borderInlineEnd: 0,
          ...
          },
          {
            [`${n}-inline`]: {
              ...
              [`${n}-sub${n}-inline`]: {
                ...
                [`& ${n}-item-group-title`]: { paddingInlineStart: c },
              },
              [`${n}-item`]: x,
            },
          },
          ...
          > ${n}-submenu > ${n}-submenu-title`]: {
                insetInlineStart: 0,
                paddingInline: `calc(50% - ${(0, $.bf)(
                  a.calc(j).div(2).equal()
                )} - ${(0, $.bf)(h)})`,
                textOverflow: "clip",
                [`
            ${n}-submenu-arrow,
          ...
          `]: { opacity: 0 },
              ...
              [`${n}-item-icon, ${o}`]: { display: "inline-block" },
              "&-tooltip": {
                pointerEvents: "none",
                [`${n}-item-icon, ${o}`]: { display: "none" },
                "a, a:hover": { color: i },
              },
              [`${n}-item-group-title`]: Object.assign(
                Object.assign({}, Z.vS),
                { paddingInline: O }
              ),
            },
      ...
      const ue = (a) => {
          ...
          return {
            [`${n}-item, ${n}-submenu-title`]: {
              ...
              [`${n}-item-icon`]: Object.assign({}, (0, Z.Ro)()),
              [`&${n}-item-only-child`]: {
                [`> ${s}, > ${n}-item-icon`]: { marginInlineEnd: 0 },
              },
            },
          ...
          return {
            [`${n}-submenu`]: {
              "&-expand-icon, &-arrow": {
                ...
                transition: `transform ${o} ${u}, opacity ${o}`,
              },
              "&-arrow": {
                "&::before, &::after": {
                  position: "absolute",
                  width: a.calc(r).mul(0.6).equal(),
                  height: a.calc(r).mul(0.15).equal(),
                ...
                "&::before": {
                  transform: `rotate(45deg) translateY(${(0, $.bf)(
                    a.calc(s).mul(-1).equal()
                  )})`,
                },
                "&::after": {
                  transform: `rotate(-45deg) translateY(${(0, $.bf)(s)})`,
                },
              },
            },
          };
        ...
        ye = (a) => {
          const {
            ...
            zIndexPopup: w,
            borderRadiusLG: y,
            subMenuItemBorderRadius: O,
            menuArrowSize: P,
            menuArrowOffset: F,
            lineType: j,
            groupTitleLineHeight: x,
            groupTitleFontSize: A,
          } = a;
          return [
            {
              "": {
                [o]: Object.assign(Object.assign({}, (0, Z.dF)()), {
                  "&-hidden": { display: "none" },
                }),
              },
                    ...
                    ),
                    {
                      ...
                      "&-submenu": {
                        "&-popup": {
                          ...
                          [`> ${o}`]: Object.assign(
                            Object.assign(
                              Object.assign({ borderRadius: y }, ue(a)),
                              ce(a)
                            ),
                            {
                              [`${o}-item, ${o}-submenu > ${o}-submenu-title`]:
        ...
        &-inline ${o}-submenu-arrow`]: {
                    "&::before": {
                      transform: `rotate(-45deg) translateX(${(0, $.bf)(F)})`,
                    },
                    "&::after": {
                      transform: `rotate(45deg) translateX(${(0, $.bf)(
                        a.calc(F).mul(-1).equal()
                      )})`,
                    },
                  },
            ...
            { [`${n}-layout-header`]: { [o]: { lineHeight: "inherit" } } },
          ];
        },
        $e = (a) => {
          var n, o, u;
          const {
            ...
            je = (n = a.activeBarWidth) !== null && n !== void 0 ? n : 0,
            ve = (o = a.activeBarBorderWidth) !== null && o !== void 0 ? o : O,
            G =
              (u = a.itemMarginInline) !== null && u !== void 0
                ? u
                : a.marginXXS,
            q = new _.t(J).setA(0.65).toRgbString();
          return {
            dropdownWidth: 160,
            zIndexPopup: a.zIndexPopupBase + 50,
            radiusItem: a.borderRadiusLG,
            itemBorderRadius: a.borderRadiusLG,
            radiusSubMenuItem: a.borderRadiusSM,
            subMenuItemBorderRadius: a.borderRadiusSM,
            colorItemText: c,
            itemColor: c,
            ...
            activeBarHeight: P,
            colorActiveBarBorderSize: O,
            activeBarBorderWidth: ve,
            ...
            iconSize: ae,
            iconMarginInlineEnd: ne - ae,
            collapsedIconSize: de,
            groupTitleFontSize: ae,
            darkItemDisabledColor: new _.t(J).setA(0.25).toRgbString(),
            darkItemColor: q,
            darkDangerItemColor: r,
            darkItemBg: "#001529",
            darkPopupBg: "#001529",
            darkSubMenuItemBg: "#000c17",
            darkItemSelectedColor: J,
            darkItemSelectedBg: i,
            darkDangerItemSelectedBg: r,
            darkItemHoverBg: "transparent",
            darkGroupTitleColor: q,
            darkItemHoverColor: J,
            darkDangerItemHoverColor: Oe,
            darkDangerItemSelectedColor: J,
            darkDangerItemActiveBg: r,
            itemWidth: je ? `calc(100% + ${ve}px)` : `calc(100% - ${G * 2}px)`,
          };
        };
      var ze = (a, n = a, o = !0) =>
          (0, V.I$)(
            ...
            (i) => {
              const {
                  ...
                  fontSize: p,
                  darkItemColor: c,
                  darkDangerItemColor: h,
                  darkItemBg: C,
                  darkSubMenuItemBg: w,
                  darkItemSelectedColor: y,
                  darkItemSelectedBg: O,
                  darkDangerItemSelectedBg: P,
                  darkItemHoverBg: F,
                  darkGroupTitleColor: j,
                  darkItemHoverColor: x,
                  darkItemDisabledColor: A,
                  darkDangerItemHoverColor: ee,
                  darkDangerItemSelectedColor: X,
                  darkDangerItemActiveBg: K,
                  popupBg: ae,
                  darkPopupBg: ne,
                } = i,
                de = i.calc(p).div(7).mul(5).equal(),
                J = (0, re.IX)(i, {
                  menuArrowSize: de,
                  menuHorizontalHeight: i.calc(s).mul(1.15).equal(),
                  menuArrowOffset: i.calc(de).mul(0.25).equal(),
                  menuSubMenuBg: r,
                  calc: i.calc,
                  popupBg: ae,
                }),
        ...
        xe = (a) => {
          var n;
          const { popupClassName: o, icon: u, title: i, theme: r } = a,
            s = e.useContext(z),
            { prefixCls: p, inlineCollapsed: c, theme: h } = s,
            C = (0, B.Xl)();
          let w;
          if (!u)
            w =
              c && !C.length && i && typeof i == "string"
                ? e.createElement(
                    "div",
                    { className: `${p}-inline-collapsed-noicon` },
                    i.charAt(0)
                  )
                : e.createElement(
                    "span",
                    { className: `${p}-title-content` },
                    i
                  );
          else {
            const P = e.isValidElement(i) && i.type === "span";
            w = e.createElement(
              e.Fragment,
              null,
              (0, L.Tm)(u, {
          ...
          return e.createElement(
            ...
            e.createElement(
              B.Wd,
              Object.assign({}, (0, R.Z)(a, ["icon"]), {
                title: w,
                popupClassName: U()(p, o, `${p}-${r || h}`),
                popupStyle: Object.assign({ zIndex: O }, a.popupStyle),
              })
            )
          );
        },
      ...
      const l = { item: he, submenu: xe, divider: ie };
      var f = (0, e.forwardRef)((a, n) => {
        var o;
        const u = e.useContext(Ae.Z),
          i = u || {},
          {
            getPrefixCls: r,
            getPopupContainer: s,
          ...
          h = r(),
          {
            ...
            selectable: X,
            onClick: K,
            overflowedIndicatorPopupClassName: ae,
          } = a,
          ne = d(a, [
            "prefixCls",
            "className",
          ...
          de = (0, R.Z)(ne, ["collapsedWidth"]);
        (o = i.validator) === null || o === void 0 || o.call(i, { mode: ee });
        const J = (0, T.Z)((...Re) => {
            var Se;
            K == null || K.apply(void 0, Re),
              (Se = i.onClick) === null || Se === void 0 || Se.call(i);
          }),
          Oe = i.mode || ee,
          je = X != null ? X : i.selectable,
          ve = j != null ? j : x,
          G = {
            horizontal: { motionName: `${h}-slide-up` },
            inline: (0, W.Z)(h),
            other: { motionName: `${h}-zoom-big` },
          },
          q = r("menu", C || i.prefixCls),
          fe = (0, I.Z)(q),
          [Xe, Ue, Be] = ze(q, fe, !u),
          Ze = U()(`${q}-${O}`, c == null ? void 0 : c.className, w),
          Ye = e.useMemo(() => {
            var Re, Se;
            if (typeof P == "function" || m(P)) return P || null;
            if (typeof i.expandIcon == "function" || m(i.expandIcon))
              return i.expandIcon || null;
            if (
              typeof (c == null ? void 0 : c.expandIcon) == "function" ||
              m(c == null ? void 0 : c.expandIcon)
            )
              return (c == null ? void 0 : c.expandIcon) || null;
            const Ke =
              (Re = P != null ? P : i == null ? void 0 : i.expandIcon) !==
                null && Re !== void 0
                ? Re
                : c == null
                ? void 0
            ...
            e.createElement(
              ...
              e.createElement(
                ...
                Object.assign(
                  {
                    getPopupContainer: s,
                    overflowedIndicator: e.createElement(D.Z, null),
                    overflowedIndicatorPopupClassName: U()(q, `${q}-${O}`, ae),
                    mode: Oe,
                    selectable: je,
                    onClick: J,
                  },
                  de,
                  {
                    ...
                    expandIcon: Ye,
                    ref: n,
                    rootClassName: U()(A, Ue, i.rootClassName, Be, fe),
                    _internalComponents: l,
                  }
                )
              )
            )
      ...
      const b = (0, e.forwardRef)((a, n) => {
        ...
        return (
          (0, e.useImperativeHandle)(n, () => ({
            ...
            focus: (i) => {
              var r;
              (r = o.current) === null || r === void 0 || r.focus(i);
            },
          })),
          e.createElement(f, Object.assign({ ref: o }, a, u))
        );
      });
      (b.Item = he), (b.SubMenu = xe), (b.Divider = ie), (b.ItemGroup = B.BW);
      var E = b;
    },
    22181: function (Y, Q, t) {
      "use strict";
      t.d(Q, {
        ZP: function () {
          return He;
      ...
      var e = t(67294),
        ...
        R = t(84089),
        W = function (M, oe) {
          return e.createElement(R.Z, (0, H.Z)({}, M, { ref: oe, icon: T }));
        },
        L = e.forwardRef(W),
        k = L,
        I = t(93967),
        ...
        Ee = () =>
          e.createElement(
            ...
            e.createElement("title", null, "No Found"),
            e.createElement(
              "g",
        ...
        be = () =>
          e.createElement(
            ...
            e.createElement("title", null, "Server Error"),
            e.createElement(
              "g",
              { fill: "none", fillRule: "evenodd" },
              e.createElement("path", {
      ...
      const Ae = (S) => {
          ...
          return {
            [M]: {
              padding: `${(0, Pe.bf)(S.calc($e).mul(2).equal())} ${(0, Pe.bf)(
                ce
              )}`,
              "&-rtl": { direction: "rtl" },
            },
            ...
            [`${M} ${M}-icon`]: {
              marginBottom: $e,
              textAlign: "center",
              [`& > ${Ce}`]: { fontSize: S.iconFontSize },
            },
            [`${M} ${M}-title`]: {
              color: S.colorTextHeading,
            ...
            [`${M} ${M}-content`]: {
              marginTop: $e,
              padding: `${(0, Pe.bf)($e)} ${(0, Pe.bf)(
                S.calc(ue).mul(2.5).equal()
              )}`,
              backgroundColor: S.colorFillAlter,
            },
            [`${M} ${M}-extra`]: {
              margin: S.extraMargin,
              textAlign: "center",
              "& > *": {
                marginInlineEnd: ye,
        ...
        $ = (S) => {
          const { componentCls: M, iconCls: oe } = S;
          return {
            [`${M}-success ${M}-icon > ${oe}`]: {
              color: S.resultSuccessIconColor,
            },
            [`${M}-error ${M}-icon > ${oe}`]: { color: S.resultErrorIconColor },
            [`${M}-info ${M}-icon > ${oe}`]: { color: S.resultInfoIconColor },
            [`${M}-warning ${M}-icon > ${oe}`]: {
              color: S.resultWarningIconColor,
            },
          };
        },
        _ = (S) => [Ae(S), $(S)],
        Z = (S) => _(S),
        le = (S) => ({
          titleFontSize: S.fontSizeHeading3,
          subtitleFontSize: S.fontSize,
          iconFontSize: S.fontSizeHeading3 * 3,
          extraMargin: `${S.paddingLG}px 0 0 0`,
        });
      var ge = (0, Le.I$)(
          "Result",
          (S) => {
            const M = S.colorInfo,
              ...
              ue = S.colorWarning,
              ce = (0, he.IX)(S, {
                resultInfoIconColor: M,
                resultErrorIconColor: oe,
                resultSuccessIconColor: Ce,
                resultWarningIconColor: ue,
                imageWidth: 250,
                imageHeight: 295,
              });
            return [Z(ce)];
        ...
        V = () =>
          e.createElement(
            ...
            e.createElement("title", null, "Unauthorized"),
            e.createElement(
              "g",
              { fill: "none", fillRule: "evenodd" },
              e.createElement("path", {
      ...
      const re = { success: B.Z, error: v.Z, info: D.Z, warning: k },
        se = { 404: Ee, 500: be, 403: V },
        me = Object.keys(se),
        pe = ({ prefixCls: S, icon: M, status: oe }) => {
          const Ce = N()(`${S}-icon`);
          if (me.includes(`${oe}`)) {
            const ce = se[oe];
            return e.createElement(
              "div",
              { className: `${Ce} ${S}-image` },
              e.createElement(ce, null)
            );
          }
          const ue = e.createElement(re[oe]);
          return M === null || M === !1
            ? null
            : e.createElement("div", { className: Ce }, M || ue);
        },
        Ne = ({ prefixCls: S, extra: M }) =>
          M ? e.createElement("div", { className: `${S}-extra` }, M) : null,
        Me = ({
          prefixCls: S,
          className: M,
          rootClassName: oe,
          ...
          return l(
            e.createElement(
              "div",
              { className: b, style: E },
              e.createElement(pe, { prefixCls: m, status: $e, icon: ze }),
              e.createElement("div", { className: `${m}-title` }, ue),
              Ce && e.createElement("div", { className: `${m}-subtitle` }, Ce),
              e.createElement(Ne, { prefixCls: m, extra: Fe }),
              ye && e.createElement("div", { className: `${m}-content` }, ye)
            )
          );
        };
      (Me.PRESENTED_IMAGE_403 = se[403]),
        (Me.PRESENTED_IMAGE_404 = se[404]),
        (Me.PRESENTED_IMAGE_500 = se[500]);
      var He = Me;
    },
    48054: function (Y, Q, t) {
      "use strict";
      t.d(Q, {
        Z: function () {
          return xe;
      ...
      var e = t(67294),
        ...
        H = t(98423),
        T = (d) => {
          const { prefixCls: m, className: l, style: g, size: f, shape: b } = d,
            E = v()({ [`${m}-lg`]: f === "large", [`${m}-sm`]: f === "small" }),
            a = v()({
              [`${m}-circle`]: b === "circle",
              [`${m}-square`]: b === "square",
              [`${m}-round`]: b === "round",
            ...
            n = e.useMemo(
              () =>
                typeof f == "number"
                  ? { width: f, height: f, lineHeight: `${f}px` }
                  : {},
              [f]
            );
          return e.createElement("span", {
            className: v()(m, E, a, l),
            style: Object.assign(Object.assign({}, n), g),
          });
        },
        R = t(11568),
        W = t(83559),
        L = t(83262);
      const k = new R.E4("ant-skeleton-loading", {
          "0%": { backgroundPosition: "100% 50%" },
          "100%": { backgroundPosition: "0 50%" },
        }),
        I = (d) => ({ height: d, lineHeight: (0, R.bf)(d) }),
        N = (d) => Object.assign({ width: d }, I(d)),
        z = (d) => ({
          background: d.skeletonLoadingBackground,
          backgroundSize: "400% 100%",
          animationName: k,
          animationDuration: d.skeletonLoadingMotionDuration,
          animationTimingFunction: "ease",
          animationIterationCount: "infinite",
        }),
        te = (d, m) =>
          Object.assign(
            { width: m(d).mul(5).equal(), minWidth: m(d).mul(5).equal() },
            I(d)
          ),
        Ee = (d) => {
          const {
          ...
          return {
            [m]: Object.assign(
              { display: "inline-block", verticalAlign: "top", background: l },
              N(g)
            ),
            [`${m}${m}-circle`]: { borderRadius: "50%" },
            [`${m}${m}-lg`]: Object.assign({}, N(f)),
            [`${m}${m}-sm`]: Object.assign({}, N(b)),
          };
        },
        ie = (d) => {
          const {
          ...
          return {
            ...
            [`${g}-lg`]: Object.assign({}, te(f, a)),
            [`${g}-sm`]: Object.assign({}, te(b, a)),
          };
        },
        be = (d) => Object.assign({ width: d }, I(d)),
        Pe = (d) => {
          const {
            skeletonImageCls: m,
            imageSizeBase: l,
          ...
          return {
            [m]: Object.assign(
              ...
              {
                [`${m}-path`]: { fill: "#bfbfbf" },
                [`${m}-svg`]: Object.assign(Object.assign({}, be(l)), {
                  maxWidth: b(l).mul(4).equal(),
                  maxHeight: b(l).mul(4).equal(),
                }),
                [`${m}-svg${m}-svg-circle`]: { borderRadius: "50%" },
              }
            ),
            [`${m}${m}-circle`]: { borderRadius: "50%" },
          };
        ...
        Le = (d, m, l) => {
          const { skeletonButtonCls: g } = d;
          return {
            [`${l}${g}-circle`]: { width: m, minWidth: m, borderRadius: "50%" },
            [`${l}${g}-round`]: { borderRadius: m },
          };
        },
        he = (d, m) =>
          Object.assign(
            { width: m(d).mul(2).equal(), minWidth: m(d).mul(2).equal() },
            I(d)
          ),
        Ae = (d) => {
          const {
            ...
            Object.assign(
              Object.assign(
                Object.assign(
                      ...
                      [l]: Object.assign(
                        {
                          ...
                          background: E,
                          borderRadius: m,
                          width: a(g).mul(2).equal(),
                          minWidth: a(g).mul(2).equal(),
                        },
                        he(g, a)
                      ),
                    },
                  ...
                  { [`${l}-lg`]: Object.assign({}, he(f, a)) }
                ),
                Le(d, f, `${l}-lg`)
              ),
              { [`${l}-sm`]: Object.assign({}, he(b, a)) }
            ),
            Le(d, b, `${l}-sm`)
          );
        },
          ...
          return {
            [m]: {
              ...
              [`${m}-header`]: {
                ...
                [`${l}-circle`]: { borderRadius: "50%" },
                [`${l}-lg`]: Object.assign({}, N(o)),
                [`${l}-sm`]: Object.assign({}, N(u)),
              },
              [`${m}-content`]: {
                display: "table-cell",
                width: "100%",
                ...
                [`${f}> li:last-child:not(:first-child):not(:nth-child(2))`]: {
                  width: "61%",
                },
              },
              [`&-round ${m}-content`]: {
                [`${g}, ${f} > li`]: { borderRadius: p },
              },
            },
            [`${m}-with-avatar ${m}-content`]: {
              [g]: { marginBlockStart: s, [`+ ${f}`]: { marginBlockStart: y } },
            },
            [`${m}${m}-element`]: Object.assign(
              Object.assign(
                Object.assign(
                  Object.assign(
      ...
      `]: Object.assign({}, z(d)),
        ...
        _ = (d) => {
          const { colorFillContent: m, colorFill: l } = d,
            g = m,
            f = l;
          return {
            color: g,
            ...
            gradientFromColor: g,
            gradientToColor: f,
            titleHeight: d.controlHeight / 2,
            blockRadius: d.borderRadiusSM,
            paragraphMarginTop: d.marginLG + d.marginXXS,
            paragraphLiHeight: d.controlHeight / 2,
          };
        };
      var Z = (0, W.I$)(
          "Skeleton",
          (d) => {
            const { componentCls: m, calc: l } = d,
              g = (0, L.IX)(d, {
                skeletonAvatarCls: `${m}-avatar`,
                skeletonTitleCls: `${m}-title`,
                skeletonParagraphCls: `${m}-paragraph`,
                skeletonButtonCls: `${m}-button`,
                skeletonInputCls: `${m}-input`,
                skeletonImageCls: `${m}-image`,
                imageSizeBase: l(d.controlHeight).mul(1.5).equal(),
                borderRadius: 100,
                skeletonLoadingBackground: `linear-gradient(90deg, ${d.gradientFromColor} 25%, ${d.gradientToColor} 37%, ${d.gradientFromColor} 63%)`,
        ...
        ge = (d) => {
          const {
            ...
            { getPrefixCls: a } = e.useContext(D.E_),
            n = a("skeleton", m),
            [o, u, i] = Z(n),
            r = (0, H.Z)(d, ["prefixCls", "className"]),
            s = v()(n, `${n}-element`, { [`${n}-active`]: f }, l, g, u, i);
          return o(
            e.createElement(
              "div",
              { className: s },
              e.createElement(
                T,
                Object.assign(
                  { prefixCls: `${n}-avatar`, shape: b, size: E },
                  r
                )
              )
            )
        ...
        V = (d) => {
          ...
          return o(
            e.createElement(
              ...
              e.createElement(
                T,
                Object.assign({ prefixCls: `${n}-button`, size: E }, r)
              )
            )
          );
        };
      ...
      var me = (d) => {
          const {
            ...
            { getPrefixCls: E } = e.useContext(D.E_),
            a = E("skeleton", m),
            [n, o, u] = Z(a),
            i = v()(a, `${a}-element`, { [`${a}-active`]: b }, l, g, o, u);
          return n(
            e.createElement(
              "div",
              { className: i },
              e.createElement(
                ...
                e.createElement(
                  ...
                  e.createElement("title", null, "Image placeholder"),
                  e.createElement("path", {
                    d: re,
        ...
        Ne = (d) => {
          ...
          return o(
            e.createElement(
              ...
              e.createElement(
                T,
                Object.assign({ prefixCls: `${n}-input`, size: E }, r)
              )
            )
          );
        },
        He = (d) => {
          const {
            ...
            n = a("skeleton", m),
            [o, u, i] = Z(n),
            r = v()(n, `${n}-element`, { [`${n}-active`]: b }, u, l, g, i);
          return o(
            e.createElement(
              "div",
              { className: r },
      ...
      const S = (d, m) => {
        const { width: l, rows: g = 2 } = m;
        if (Array.isArray(l)) return l[d];
        if (g - 1 === d) return l;
      };
      var oe = (d) => {
          const { prefixCls: m, className: l, style: g, rows: f = 0 } = d,
            b = Array.from({ length: f }).map((E, a) =>
              e.createElement("li", { key: a, style: { width: S(a, d) } })
            );
          return e.createElement("ul", { className: v()(m, l), style: g }, b);
        },
        ue = ({ prefixCls: d, className: m, width: l, style: g }) =>
          e.createElement("h3", {
            className: v()(d, m),
            style: Object.assign({ width: l }, g),
          });
      function ce(d) {
      ...
      function $e(d, m) {
        return !d && m ? { width: "38%" } : d && m ? { width: "50%" } : {};
      }
      function ze(d, m) {
        const l = {};
        return (
          (!d || !m) && (l.width = "61%"),
          !d && m ? (l.rows = 3) : (l.rows = 2),
          l
        );
      }
      const Fe = (d) => {
        ...
        if (l || !("loading" in d)) {
          ...
          if (O) {
            const ee = Object.assign(
              Object.assign({ prefixCls: `${h}-avatar` }, ye(P, F)),
              ce(a)
            );
            j = e.createElement(
              "div",
              { className: `${h}-header` },
              e.createElement(T, Object.assign({}, ee))
            );
          }
          let x;
          if (P || F) {
            ...
            if (P) {
              const K = Object.assign(
                Object.assign({ prefixCls: `${h}-title` }, $e(O, F)),
                ce(n)
              );
              ee = e.createElement(ue, Object.assign({}, K));
            }
            let X;
            if (F) {
              const K = Object.assign(
                Object.assign({ prefixCls: `${h}-paragraph` }, ze(O, P)),
                ce(o)
              );
              X = e.createElement(oe, Object.assign({}, K));
            }
            x = e.createElement("div", { className: `${h}-content` }, ee, X);
          }
          const A = v()(
            h,
            {
          ...
          return C(
            e.createElement(
              "div",
              { className: A, style: Object.assign(Object.assign({}, c), b) },
              j,
              x
            )
          );
    ...
    16569: function (Y, Q, t) {
      ...
      var e = t(67294),
        B = t(66680);
      function v() {}
      const D = e.createContext({ add: v, remove: v });
      function H(T) {
        const R = e.useContext(D),
          W = e.useRef(null);
        return (0, B.Z)((k) => {
          if (k) {
            const I = T ? k.querySelector(T) : k;
            I && (R.add(I), (W.current = I));
          } else R.remove(W.current);
        });
      }
      var U = null;
    },
    96446: function (Y, Q, t) {
      var e = t(37923);
      function B(v) {
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
    ...
    19632: function (Y, Q, t) {
      var e = t(96446),
        B = t(96936),
        v = t(96263),
        D = t(88619);
      function H(U) {
        return e(U) || B(U) || v(U) || D();
      }
      (Y.exports = H),
        (Y.exports.__esModule = !0),
        (Y.exports.default = Y.exports);
